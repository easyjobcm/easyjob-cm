export const fr = {
  ...
  home: {
    ...
    hero: {
      ...
      subtitle: 'La plateforme qui connecte les talents camerounais aux entreprises locales. Paiement Mobile Money, contrat digital, confiance garantie.',
    ...
    how: {
      ...
      cStep1Desc: "Inscription en 2 min. Photo, compétences, CNI vérifiée. L'IA complète votre profil automatiquement.",
      cStep2Title: 'Postulez en 1 clic',
      cStep2Desc: 'Trouvez une offre adaptée à vos disponibilités. Aucun message requis. Réponse rapide.',
      cStep3Title: 'Recevez votre paiement',
      cStep3Desc: 'Mission validée ? Votre paiement arrive directement sur votre MoMo MTN ou Orange Money.',
      eStep1Title: 'Décrivez votre besoin',
      eStep1Desc: "En quelques mots. L'IA génère votre offre complète et structurée en moins de 5 secondes.",
      eStep2Title: 'Recevez des profils triés',
      eStep2Desc: 'Notre algorithme vous présente les candidats les plus proches et les plus adaptés en premier.',
      eStep3Title: 'Mission accomplie',
      eStep3Desc: 'Validez la fin de mission. Le paiement des candidats est géré automatiquement par EasyJob CM.',
    },
    features: {
      title: 'Pourquoi choisir EasyJob CM',
      f1Title: 'Paiement Mobile Money',
      f1Desc: 'MTN MoMo & Orange Money. Paiement garanti, délai transparent selon votre profil.',
      f2Title: 'Contrat digital',
      f2Desc: 'Chaque mission est couverte par un contrat signé électroniquement. Zéro litige.',
      f3Title: 'Système de confiance',
      f3Desc: 'Le niveau Sandbox récompense la fiabilité. Montez en grade, accédez aux meilleures offres.',
      f4Title: 'Matching par IA',
      f4Desc: "L'algorithme vous recommande les missions les plus proches de chez vous et de votre profil.",
    },
    sandbox: {
      title: 'Un système de confiance unique',
      subtitle: 'Progressez mission après mission. Chaque niveau débloque de nouvelles opportunités.',
      l0Name: 'Nouveau',
    ...
    cta: {
      ...
      subtitle: 'Rejoignez des centaines de candidats et entreprises à Douala et Yaoundé.',
  ...
  chatbot: {
    ...
    greeting: "Bonjour ! Je suis EasyBot, votre assistant virtuel. Comment puis-je vous aider aujourd'hui ?",
