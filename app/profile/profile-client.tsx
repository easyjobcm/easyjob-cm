...
export function ProfileClient({ user, profile, skills }: ProfileClientProps) {
  ...
  return (
    <AppShell hideNav>
      <Header 
        title={locale === 'fr' ? 'Mon Profil' : 'My Profile'}
        showBack
      />
      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <div className="flex items-center gap-4">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center text-white text-2xl font-bold shadow-lg">
            {profile?.first_name?.[0] || profile?.company_name?.[0] || user.phone?.[0] || 'U'}
          </div>
          <div className="flex-1">
            <h1 className="text-xl font-bold text-foreground">
              {isCandidate 
                ? `${profile?.first_name || ''} ${profile?.last_name || ''}`.trim() || user.phone
        ...
        <div className="space-y-2">
          ...
          <Card>
            <CardContent className="p-0 divide-y divide-border">
              {isCandidate && (
                <Link href="/profile/availability" className="flex items-center justify-between p-4 hover:bg-muted/50 transition-colors">
                  <div className="flex items-center gap-3">
              ...
              <Link href="/profile/payment" className="flex items-center justify-between p-4 hover:bg-muted/50 transition-colors">
                <div className="flex items-center gap-3">
              ...
              <Link href="/profile/notifications" className="flex items-center justify-between p-4 hover:bg-muted/50 transition-colors">
                <div className="flex items-center gap-3">
              ...
              <Link href="/profile/security" className="flex items-center justify-between p-4 hover:bg-muted/50 transition-colors">
                <div className="flex items-center gap-3">
