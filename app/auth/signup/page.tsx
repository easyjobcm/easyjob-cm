...
export default function SignupPage() {
  ...
  const [step, setStep] = React.useState<"role" | "phone" | "otp" | "password">(
    "role",
  );
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      setError(
        message ||
          (locale === "fr" ? "Erreur lors de l'inscription" : "Signup error"),
      );
    } finally {
      setLoading(false);
    }
  ...
  const roleOptions = [
    {
      ...
      icon: Briefcase,
      title:
        locale === "fr" ? "Je cherche des missions" : "I'm looking for jobs",
      description:
        locale === "fr"
