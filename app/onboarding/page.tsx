...
export default function OnboardingPage() {
  ...
  const isStepValid = () => {
    switch (currentStep) {
      case 'identity':
        return formData.firstName && formData.lastName && formData.birthDate && formData.cniNumber
      case 'momo':
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <Header 
        title={locale === 'fr' ? 'Completez votre profil' : 'Complete your profile'}
        ...
        {currentStep === 'identity' && (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-sm font-medium text-foreground">
                  {locale === 'fr' ? 'Photo de la CNI (recto)' : 'ID card photo (front)'}
                </label>
              ...
              <Card className="bg-primary/5 border-primary/20">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={() => setFormData(prev => ({ ...prev, gpsEnabled: !prev.gpsEnabled }))}
                      className={cn(
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          formData.gpsEnabled ? 'translate-x-5' : 'translate-x-0.5'
                        )}
                      />
                    </button>
                  </div>
