...
import { ClipboardList, Calendar, ChevronRight, MapPin, Clock, Building2, QrCode, CheckCircle, Loader2 } from 'lucide-react'
...
export default function TasksPage() {
  ...
  const renderMissionCard = (mission: Mission) => {
    const isActive = mission.status === 'in_progress' || isToday(mission.scheduled_date)
      ...
      >
        <CardContent className="p-4">
          ...
          <div className="pt-3 border-t border-border flex justify-between items-center">
            ...
            {isActive && mission.arrival_validated && !mission.departure_validated && (
