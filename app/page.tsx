...
function resetCookies() {
  try {
    localStorage.removeItem("ej_cookie_consent");
  } catch {
    /* ignore */
  }
  document.cookie =
    "ej_consent=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/";
...
export default function WelcomePage() {
  ...
  const candidateSteps = [
    {
      step: t("home.how.step1"),
      title: t("home.how.cStep1Title"),
      desc: t("home.how.cStep1Desc"),
      icon: BadgeCheck,
    },
    {
      step: t("home.how.step2"),
      title: t("home.how.cStep2Title"),
      desc: t("home.how.cStep2Desc"),
      icon: Briefcase,
    },
    {
      step: t("home.how.step3"),
      title: t("home.how.cStep3Title"),
      desc: t("home.how.cStep3Desc"),
      icon: Banknote,
    },
  ];
  const companySteps = [
    {
      step: t("home.how.step1"),
      title: t("home.how.eStep1Title"),
      desc: t("home.how.eStep1Desc"),
      icon: Zap,
    },
    {
      step: t("home.how.step2"),
      title: t("home.how.eStep2Title"),
      desc: t("home.how.eStep2Desc"),
      icon: Users,
    },
    {
      step: t("home.how.step3"),
      title: t("home.how.eStep3Title"),
      desc: t("home.how.eStep3Desc"),
      icon: CheckCircle,
    },
  ];
  const activeSteps = activeTab === "candidate" ? candidateSteps : companySteps;
  const sandboxNames = [
    t("home.sandbox.l0Name"),
    t("home.sandbox.l1Name"),
    t("home.sandbox.l2Name"),
    t("home.sandbox.l3Name"),
  ];
  const sandboxDescs = [
    t("home.sandbox.l0Desc"),
    t("home.sandbox.l1Desc"),
    t("home.sandbox.l2Desc"),
  ...
  const gradTitleLight: React.CSSProperties = {
    backgroundImage:
      "linear-gradient(135deg, #1E1B4B 0%, #5B21B6 55%, #7C3AED 100%)",
  ...
  const gradTitle: React.CSSProperties = {
    backgroundImage:
      "linear-gradient(135deg, #fff 0%, #DDD6FE 45%, #A78BFA 80%, #7C3AED 100%)",
    WebkitBackgroundClip: "text",
    WebkitTextFillColor: "transparent",
    backgroundClip: "text",
  };
  ...
  return (
    <div
      className={`flex min-h-screen flex-col ${isDark ? "bg-[#0D0618]" : "bg-white"} overflow-x-hidden transition-colors duration-300`}
    >
            ...
            <span
              ...
              style={
                scrolled && !isDark
                  ? { color: "#7C3AED" }
                  : {
                      backgroundImage: "linear-gradient(135deg,#fff,#A78BFA)",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                      backgroundClip: "text",
                    }
          ...
          <nav className="hidden lg:flex items-center gap-7">
            {navLinks.map((l) => (
              <Link
                key={l.href}
                href={l.href}
                className={`text-[13px] font-medium transition-colors ${scrolled && !isDark ? "text-[#6B7280] hover:text-[#111827]" : "text-white/50 hover:text-white"}`}
              >
                {l.label}
              </Link>
            ))}
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-24 w-full lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            >
              <motion.button
                ...
                style={{
                  background: "linear-gradient(135deg,#7C3AED,#5B21B6)",
                  boxShadow:
                    "0 0 32px rgba(124,58,237,0.55),0 8px 24px rgba(124,58,237,0.3)",
                }}
              >
                <Smartphone className="w-5 h-5" />
                {t("home.hero.ctaCandidate")}
          ...
          >
            ...
            <div className="relative w-63.75 sm:w-71.25">
              {/* Phone shell */}
              <div
                className="relative rounded-[36px] p-3.5 border"
                style={{
                  background: "linear-gradient(145deg,#1A0A2E,#0D0618)",
                  borderColor: "rgba(124,58,237,0.28)",
                  boxShadow:
                    "0 32px 80px rgba(0,0,0,0.65),0 0 0 1px rgba(124,58,237,0.12),inset 0 1px 0 rgba(255,255,255,0.04)",
                }}
              >
                <div className="rounded-[26px] overflow-hidden">
                  ...
                  >
                    ...
                    <p className="text-white/55 text-[10px]">
                      {t("landing.mockup.jobsNear")}
                    </p>
                    <p className="text-white text-[13px] font-bold mt-0.5">
                      {t("landing.mockup.doualaCount")}
                    </p>
                  </div>
                  ...
                  <div className="px-3 py-3 space-y-2 bg-[#F5F3FF]">
                    {[
                      ...
                      >
                        <div className="flex items-start justify-between mb-1.5">
                          ...
                          {job.urgent && (
                            <span className="text-[8px] font-bold text-[#7C3AED] bg-[#EDE9FE] px-1.5 py-0.5 rounded-full">
                              URGENT
                            </span>
                          )}
                        </div>
                    ...
                    >
                      <span className="text-white text-[11px] font-bold">
                        ✓ {t("landing.mockup.applyOneClick")}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <motion.div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 4px 20px rgba(52,211,153,0.18),inset 0 1px 0 rgba(255,255,255,0.04)",
                }}
              >
                <p className="text-[9px] text-white/45 mb-0.5">
                  {t("landing.mockup.paymentReceived")} 🎉
                </p>
                <p className="text-[15px] font-bold text-[#34D399]">
                  +5 000 FCFA
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 4px 20px rgba(124,58,237,0.2),inset 0 1px 0 rgba(255,255,255,0.04)",
                }}
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-[9px] text-white/45">
                      {t("landing.mockup.missionConfirmed")}
                    </p>
                    <div className="flex gap-0.5 mt-0.5">
                      {[1, 2, 3, 4, 5].map((s) => (
                        <Star
                          key={s}
                          className="w-2 h-2 text-[#D97706] fill-[#D97706]"
                        />
                      ))}
                    </div>
                  </div>
              ...
              >
                ...
                <div>
                  <p className="text-[9px] text-[#D97706] font-bold">
                    {t("landing.mockup.expert")}
                  </p>
                  <p className="text-[8px] text-white/35">4.9 ★</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
      ...
      {/* ═══════════════════════════════ STATS ═════════════════════════════════ */}
      <section
        className={`relative ${isDark ? "bg-[#0F0A1E] border-[#7C3AED]/10" : "bg-[#F5F3FF] border-[#DDD6FE]"} border-y overflow-hidden transition-colors duration-300`}
      >
        <Section>
          <div className="max-w-4xl mx-auto px-4 py-12 grid grid-cols-2 sm:grid-cols-4 gap-8 text-center relative">
            {[
              ...
              >
                ...
                <span
                  className={`text-[12px] font-medium ${isDark ? "text-white/50" : "text-[#6B7280]"}`}
                >
                  {label}
                </span>
              </motion.div>
      ...
      <section
        id="how"
        className={`relative py-24 px-4 ${isDark ? "bg-[#0D0618]" : "bg-white"} overflow-hidden transition-colors duration-300`}
      >
        <Section className="max-w-4xl mx-auto">
          <motion.div variants={fadeUp} className="text-center mb-10">
            <span className="text-[11px] font-bold uppercase tracking-[2px] text-[#7C3AED] block mb-3">
              {t("home.how.title")}
            </span>
            <h2
              className="text-[28px] sm:text-[38px] font-extrabold"
              style={isDark ? gradTitle : gradTitleLight}
            >
          ...
          <motion.div variants={fadeUp} className="flex justify-center mb-10">
            <div
              className={`relative inline-flex rounded-full p-1 ${isDark ? "bg-[#1A0A2E]" : "bg-[#F3F4F6]"}`}
            >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {activeSteps.map(({ step, title, desc, icon: Icon }, i) => (
                ...
                >
                  {i < 2 && (
                    <div className="hidden sm:block absolute top-9 right-0 w-4 h-px bg-[#DDD6FE] translate-x-full" />
                  )}
                  <div
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-[#7C3AED] block mb-1.5">
                    {step}
                  </span>
                  <h3
                    className={`text-[15px] font-bold ${isDark ? "text-white" : "text-[#111827]"} mb-2`}
                  >
                    {title}
                  </h3>
                  <p
                    className={`text-[13px] ${isDark ? "text-white/45" : "text-[#6B7280]"} leading-relaxed`}
                  >
                    {desc}
                  </p>
                </TiltCard>
      ...
      <section
        id="features"
        className={`relative py-24 px-4 ${isDark ? "bg-[#0F0A1E]" : "bg-[#FAFAFA]"} overflow-hidden transition-colors duration-300`}
      >
        <Section className="max-w-4xl mx-auto">
            ...
            {featureConfig.map(({ key, Icon, color, glow }) => (
              ...
              >
                ...
                <motion.div variants={fadeUp}>
                  <h3
                    className={`text-[15px] font-bold ${isDark ? "text-white" : "text-[#111827]"} mb-1.5`}
                  >
      ...
      >
        <Section className="max-w-4xl mx-auto">
          <motion.div variants={fadeUp} className="text-center mb-12">
            ...
            <h2
              className="text-[28px] sm:text-[38px] font-extrabold mb-3"
              style={isDark ? gradTitle : gradTitleLight}
            >
              {t("home.sandbox.title")}
            </h2>
            <p
              className={`text-[14px] ${isDark ? "text-white/50" : "text-[#6B7280]"} max-w-md mx-auto`}
            >
              {t("home.sandbox.subtitle")}
            </p>
          </motion.div>
          ...
          >
            {sandboxLevels.map((level, i) => (
              <motion.div
                ...
                style={{
                  background: `${level.glow}10`,
                  border: `1px solid ${level.glow}30`,
                  boxShadow: `0 8px 32px ${level.glow}12,inset 0 1px 0 rgba(255,255,255,0.04)`,
                }}
              >
                <div
                  className="absolute inset-0 rounded-3xl"
                  style={{
                    background: `radial-gradient(circle at 50% 20%, ${level.glow}18, transparent 60%)`,
                  }}
                />
                <SandboxSticker
                  icon={level.icon}
                ...
                <p
                  className={`text-[11px] ${isDark ? "text-white/42" : "text-[#6B7280]"} relative`}
                >
                  {sandboxDescs[i]}
                </p>
      ...
      {/* ══════════════════════════════ PWA DOWNLOAD ════════════════════════════ */}
      <section
        className={`relative py-24 px-4 overflow-hidden ${isDark ? "bg-[#0D0618]" : "bg-[#F5F3FF]"} transition-colors duration-300`}
      >
        <Section className="max-w-4xl mx-auto">
          <motion.div
            variants={fadeUp}
            ...
            style={
              isDark
                ? {
                    background: "rgba(124,58,237,0.07)",
                    border: "1px solid rgba(124,58,237,0.2)",
                    boxShadow: "0 16px 64px rgba(124,58,237,0.2)",
                  }
                : {
          ...
          >
            <div className="flex flex-col lg:flex-row items-center gap-8">
              ...
              <div className="relative shrink-0">
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow:
                      "0 12px 40px rgba(124,58,237,0.5),inset 0 1px 0 rgba(255,255,255,0.18)",
                  }}
                >
              ...
              <div className="flex-1 text-center lg:text-left">
                <h3
                  className={`text-[22px] font-extrabold ${isDark ? "text-white" : "text-[#111827]"} mb-2`}
                >
                  {t("landing.pwa.title")}
                </h3>
                <p
                  className={`text-[14px] ${isDark ? "text-white/50" : "text-[#6B7280]"} mb-4`}
                >
                  {t("landing.pwa.desc")}
                </p>
                <div className="flex flex-wrap justify-center lg:justify-start gap-2">
                  {[
                    { label: "Android", icon: "🤖" },
                    { label: "iOS / Safari", icon: "🍎" },
                    { label: "Desktop", icon: "💻" },
                  ].map(({ label, icon }) => (
                    <span
                      key={label}
                      className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[12px] font-medium text-[#7C3AED] border ${isDark ? "border-[#7C3AED]/25 bg-[#7C3AED]/10" : "border-[#DDD6FE] bg-[#EDE9FE]/40"}`}
                    >
                      {icon} {label}
                    </span>
                  ))}
                  ...
                  <>
                    <motion.button
                      ...
                      style={{
                        background: "linear-gradient(135deg,#7C3AED,#5B21B6)",
                        boxShadow:
                          "0 0 30px rgba(124,58,237,0.5),0 8px 24px rgba(124,58,237,0.3)",
                      }}
                    >
                    ...
                    <p
                      className={`text-[11px] ${isDark ? "text-white/35" : "text-[#9CA3AF]"}`}
                    >
                      {t("landing.pwa.free")}
                    </p>
                  </>
            ...
            {showInstallGuide && (
              ...
              >
                ...
                <div className="space-y-1.5 text-[13px] text-[#6B7280]">
                  <p>
                    🍎 <strong className="text-[#374151]">iOS Safari :</strong>{" "}
                    {t("landing.pwa.iosSafari")}
                  </p>
                  <p>
                    🤖{" "}
                    <strong className="text-[#374151]">Android Chrome :</strong>{" "}
                    {t("landing.pwa.android")}
                  </p>
                  <p>
                    💻 <strong className="text-[#374151]">Desktop :</strong>{" "}
                    {t("landing.pwa.desktop")}
                  </p>
                </div>
              </motion.div>
            )}
      ...
      <section className="relative py-28 px-4 bg-[#080412] overflow-hidden">
        ...
        <Section className="relative max-w-2xl mx-auto text-center">
          <motion.p
            variants={fadeUp}
            className="text-[11px] font-bold uppercase tracking-[2.5px] text-[#7C3AED] mb-4"
          >
            EasyJob CM
          </motion.p>
          <motion.h2
            variants={fadeUp}
            className="text-[32px] sm:text-[46px] font-extrabold mb-4 leading-[1.1]"
            style={gradTitle}
          >
            {t("home.cta.title")}
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="text-[15px] text-white/38 mb-10 max-w-md mx-auto"
          >
            {t("home.cta.subtitle")}
          </motion.p>
          ...
          <motion.div variants={fadeUp}>
            <motion.button
              ...
              style={{
                background: "linear-gradient(135deg,#7C3AED,#5B21B6)",
                boxShadow:
                  "0 0 48px rgba(124,58,237,0.65),0 12px 32px rgba(124,58,237,0.3)",
              }}
            >
              {t("home.cta.btn")}
      ...
      <footer className="bg-[#060310] border-t border-white/5 px-4 py-12">
        <div className="max-w-5xl mx-auto">
            ...
            <div className="flex items-center gap-2">
              {[
                ...
                },
                {
                  Ic: LinkedInIcon,
                  label: "LinkedIn",
                  href: "https://www.linkedin.com/company/easyjob-cameroun/",
                },
                {
                  Ic: InstagramIcon,
                  label: "Instagram",
                  href: "https://www.instagram.com/easyjobcameroun/",
                },
                {
                  Ic: FacebookIcon,
                  label: "Facebook",
                  href: "https://www.facebook.com/easyjobcameroun/",
                },
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mb-10 pb-10 border-b border-white/5">
            {footerCols.map((col) => (
              <div key={col.title}>
                <h4 className="text-[11px] font-bold uppercase tracking-[1.5px] text-[#7C3AED] mb-3">
                  {col.title}
                </h4>
                    ...
                    <li key={link.label}>
                      {link.onClick ? (
                        <button
                          ...
                          className="text-[12px] text-white/30 hover:text-white/65 transition-colors text-left"
                        >
                          {link.label}
                        </button>
                      ) : (
