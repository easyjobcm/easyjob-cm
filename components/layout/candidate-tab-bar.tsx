...
// paramètres...) gardent la barre avec l'onglet Profil actif, ainsi que
// `/upgrade/candidate` (Premium), `/help` (+ guide) et `/terms`, qui ne sont
// accessibles que depuis le menu Profil.
// `/profile/company` garde son propre layout (aucune barre candidat dessus).
const CANDIDATE_TAB_PREFIXES = [
  "/jobs",
  "/tasks",
  "/my-jobs",
  "/profile",
