...
import { MapPin, Clock, Calendar, Briefcase, Star, ChevronRight, Zap } from 'lucide-react'
...
export function JobCard({ job, showCompany = true, variant = 'default' }: JobCardProps) {
        ...
        <div className={cn("p-4", variant === 'compact' && "p-0")}>
          ...
          <div className="space-y-1.5 mb-3">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="truncate">{job.quartier ? `${job.quartier}, ` : ''}{job.city}</span>
            </div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
